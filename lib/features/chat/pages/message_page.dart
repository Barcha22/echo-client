...
class _MessagePageState extends State<MessagePage> with WidgetsBindingObserver {
                  ...
                  if (_controller.isFriend) {
                    AppNavigator.push(
                      ...
                      arguments: {
                        ...
                        'fullName':
                            widget.friendFullName ?? widget.friendUserName,
                  ...
                  : ScrollConfiguration(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final isMe =
                              message.senderId == _controller.currentUser?.id;
                          final isEditing =
                              _controller.editingMessageId == message.id;
                          return MessageBubble(
                            message: message,
                            isMe: isMe,
                            onLongPress: _controller.isFriend
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    if(state == AppLifecycleState.resumed){
      _controller.setPageVisibility(true);
    }else if(state == AppLifecycleState.paused){
      _controller.setPageVisibility(false);
